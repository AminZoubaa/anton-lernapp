...
// Pro Buchstabe 3–6 Anlaut-Wörter; die Lektion zeigt jeweils 2 zufällige davon.

const L = (char, words, extra = {}) => ({ type: "letter", char, words, ...extra });
...
export const CHAPTERS = [
  {
    ...
    color: "#1cb0f6",
    items: [
      L("A", [W("APFEL", ["🍎", "🍏"]), W("AFFE", ["🐵", "🐒"]), W("AMEISE", ["🐜"]), W("AUTO", ["🚗", "🚙"]), W("ANANAS", ["🍍"]), W("ADLER", ["🦅"])]),
      L("B", [W("BALL", ["⚽", "🏀", "🎾"]), W("BANANE", ["🍌"]), W("BÄR", ["🐻"]), W("BLUME", ["🌸", "🌷"]), W("BUS", ["🚌"]), W("BROT", ["🍞", "🥖"])]),
      L("C", [W("CLOWN", ["🤡", "🎪"]), W("COMPUTER", ["💻", "🖥️"]), W("CAMPING", ["⛺", "🏕️"]), W("COWBOY", ["🤠"])]),
      L("D", [W("DRACHE", ["🐉", "🐲"]), W("DELFIN", ["🐬"]), W("DINO", ["🦕", "🦖"]), W("DONUT", ["🍩"]), W("DIAMANT", ["💎"])]),
      L("E", [W("ELEFANT", ["🐘"]), W("ENTE", ["🦆", "🐤"]), W("EIS", ["🍦", "🍨"]), W("ERDBEERE", ["🍓"]), W("EULE", ["🦉"]), W("EI", ["🥚"])]),
    ],
  },
  {
    id: "abc-2",
    ...
    color: "#58cc02",
    items: [
      L("F", [W("FISCH", ["🐟", "🐠", "🐡"]), W("FROSCH", ["🐸"]), W("FUCHS", ["🦊"]), W("FEUER", ["🔥"]), W("FLUGZEUG", ["✈️"]), W("FAHRRAD", ["🚲"])]),
      L("G", [W("GESCHENK", ["🎁"]), W("GITARRE", ["🎸"]), W("GIRAFFE", ["🦒"]), W("GURKE", ["🥒"]), W("GEIST", ["👻"]), W("GLOCKE", ["🔔"])]),
      L("H", [W("HUND", ["🐶", "🐕"]), W("HAUS", ["🏠", "🏡"]), W("HASE", ["🐰", "🐇"]), W("HUT", ["🎩"]), W("HERZ", ["❤️"]), W("HAMMER", ["🔨"])]),
      L("I", [W("IGEL", ["🦔"]), W("INSEL", ["🏝️", "🏖️"]), W("INSEKT", ["🐞", "🐜"])]),
      L("J", [W("JACKE", ["🧥"]), W("JO-JO", ["🪀"]), W("JEEP", ["🚙"]), W("JAGUAR", ["🐆"])]),
      L("K", [W("KATZE", ["🐱", "🐈"]), W("KUCHEN", ["🎂", "🍰"]), W("KROKODIL", ["🐊"]), W("KIRSCHE", ["🍒"]), W("KOALA", ["🐨"]), W("KRONE", ["👑"])]),
    ],
  },
  {
    id: "abc-3",
    ...
    color: "#ff9600",
    items: [
      L("L", [W("LÖWE", ["🦁"]), W("LUFTBALLON", ["🎈"]), W("LAMPE", ["💡"]), W("LOLLI", ["🍭"]), W("LAMA", ["🦙"]), W("LOK", ["🚂"])]),
      L("M", [W("MAUS", ["🐭", "🐁"]), W("MOND", ["🌙", "🌛"]), W("MELONE", ["🍉"]), W("MÜTZE", ["🧢"]), W("MEDAILLE", ["🏅"]), W("MOTORRAD", ["🏍️"])]),
      L("N", [W("NASE", ["👃"]), W("NUDELN", ["🍝"]), W("NUSS", ["🌰"]), W("NILPFERD", ["🦛"]), W("NADEL", ["🪡"])]),
      L("O", [W("OMA", ["👵"]), W("ORANGE", ["🍊"]), W("OKTOPUS", ["🐙"]), W("OPA", ["👴"]), W("OHR", ["👂"])]),
      L("P", [W("PFERD", ["🐴", "🐎"]), W("PIZZA", ["🍕"]), W("PINGUIN", ["🐧"]), W("PAPAGEI", ["🦜"]), W("PILZ", ["🍄"]), W("PANDA", ["🐼"])]),
    ],
  },
  {
    id: "abc-4",
    ...
    items: [
      ...
      L("R", [W("RAKETE", ["🚀"]), W("REGENBOGEN", ["🌈"]), W("ROBOTER", ["🤖"]), W("ROSE", ["🌹"]), W("RAD", ["🚲"])]),
      L("S", [W("SONNE", ["☀️", "🌞"]), W("SOCKE", ["🧦"]), W("SALAT", ["🥗"]), W("SCHIFF", ["🚢", "⛵"]), W("SCHNECKE", ["🐌"])]),
      L("T", [W("TIGER", ["🐯", "🐅"]), W("TOMATE", ["🍅"]), W("TORTE", ["🍰"]), W("TELEFON", ["📞"]), W("TRAKTOR", ["🚜"]), W("TASSE", ["☕"])]),
      L("U", [W("UHR", ["⏰", "⌚", "🕐"]), W("UFO", ["🛸"]), W("UHU", ["🦉"]), W("UNTERHOSE", ["🩲"])]),
    ],
  },
  {
    id: "abc-5",
    ...
    color: "#ff86d0",
    items: [
      L("V", [W("VOGEL", ["🐦", "🦜", "🐤"]), W("VULKAN", ["🌋"]), W("VATER", ["👨"])]),
      L("W", [W("WAL", ["🐳", "🐋"]), W("WOLKE", ["☁️", "⛅"]), W("WURM", ["🐛"]), W("WÜRFEL", ["🎲"]), W("WOLF", ["🐺"]), W("WASSERMELONE", ["🍉"])]),
      // X kommt am Wortanfang fast nie vor – daher Wörter, in denen man
      // das X gut HÖRT (wie in vielen Anlauttabellen: Hexe, Boxer, Taxi).
      L("X", [W("TAXI", ["🚕", "🚖"]), W("HEXE", ["🧙‍♀️", "🧹"]), W("BOXER", ["🥊"])], { inWord: true }),
      L("Y", [W("YACHT", ["🛥️", "⛵"]), W("YOGA", ["🧘"])]),
      L("Z", [W("ZEBRA", ["🦓"]), W("ZITRONE", ["🍋"]), W("ZAHN", ["🦷"]), W("ZUG", ["🚂"]), W("ZELT", ["⛺"]), W("ZIEGE", ["🐐"])]),
    ],
  },
  {
    id: "zahlen-1",
