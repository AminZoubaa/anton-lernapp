...
function getCtx() {
  ...
  if (!ctx) {
    ...
    master.gain.value = 0.025; // sehr leise – die Stimme muss immer klar darüber liegen
...
// Im Hintergrund still (die Web-Audio-Uhr läuft auf iOS sonst weiter),
// beim Zurückkommen wieder an, wenn Musik eingeschaltet ist.
...
if (typeof document !== "undefined") {
  document.addEventListener("visibilitychange", () => {
    ...
    } else if (resumeOnVisible && isMusicOn()) {
